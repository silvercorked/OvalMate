...
void motorCallback_scheduleNextJob(stepperMotor_ctimer*);		// motorCallbacks are of this form
void motorCallback_printCurrSteps(stepperMotor_ctimer*);
void stopMotorIfJobComplete(stepperMotor_ctimer*);
