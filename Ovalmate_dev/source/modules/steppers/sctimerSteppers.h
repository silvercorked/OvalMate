...
//} stepperMotor_sctimer;
//
//// Extern Variables
//extern sctimer_config_t sctimerInfo;
//extern uint32_t sctimerClock;
//extern stepperMotor_sctimer motorX;
//extern stepperMotor_sctimer motorY;
//extern void (*stepperMotorXCallback[4])(stepperMotor_sctimer*); // function pointers
//extern void (*stepperMotorYCallback[4])(stepperMotor_sctimer*); // function pointers
//// End Extern Variables
//
//// Prototypes
//void initializeStepperPWM(void);
//status_t setupStepperPWM(
//	stepperMotor_sctimer* motorP,
