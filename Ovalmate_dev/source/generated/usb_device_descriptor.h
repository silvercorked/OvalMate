...
#define USB_INTERFACE_0_OVALMATE_CLASS (0x03U)
#define USB_INTERFACE_0_OVALMATE_SUBCLASS (0x01U)
#define USB_INTERFACE_0_OVALMATE_PROTOCOL (0x00U)
#define USB_INTERFACE_0_OVALMATE_INTERFACE_COUNT (1U)
#define USB_INTERFACE_0_OVALMATE_INDEX (0U)
#define USB_INTERFACE_0_OVALMATE_INPUT_REPORT_LENGTH (2U)
#define USB_INTERFACE_0_OVALMATE_OUTPUT_REPORT_LENGTH (8U)
#define USB_INTERFACE_0_OVALMATE_FEATURE_REPORT_LENGTH (0U)
#define USB_INTERFACE_0_OVALMATE_SETTING_0_COORDINATESTREAM_ENDPOINT_COUNT (2U)
#define USB_INTERFACE_0_OVALMATE_SETTING_0_COORDINATESTREAM_INDEX USB_ALTERNATE_SETTING_0
#define USB_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_IN (1U)
#define USB_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_IN_DIRECTION USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_IN
#define FS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_IN_PACKET_SIZE (2U)
#define HS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_IN_PACKET_SIZE (0U)
#define FS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_IN_INTERVAL (1U)
#define HS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_IN_INTERVAL (1U)
#define USB_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_OUT (1U)
#define USB_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_OUT_DIRECTION USB_DESCRIPTOR_ENDPOINT_ADDRESS_DIRECTION_OUT
#define FS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_OUT_PACKET_SIZE (8U)
#define HS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_OUT_PACKET_SIZE (0U)
#define FS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_OUT_INTERVAL (1U)
#define HS_INTERFACE_0_OVALMATE_SETTING_0_EP_1_INTERRUPT_OUT_INTERVAL (1U)

#define USB_DESCRIPTOR_LENGTH_CONFIGURATION_ALL (sizeof(g_UsbDeviceConfigurationDescriptor))

#define USB_DESCRIPTOR_LENGTH_INTERFACE_0_OVALMATE_REPORT (sizeof(g_UsbDeviceInterface0OvalmateReportDescriptor))
...
#define USB_COMPOSITE_INTERFACE_COUNT (USB_INTERFACE_0_OVALMATE_INTERFACE_COUNT)
