...
// Variables
extern uint32_t motorCallback_scheduleNextJob_steps;
// End Variables

// Macro Functions
#define driveStepperPWMBlock(whichMotor, steps, freq) \
...
void motorCallback_scheduleNextJob(stepperMotor*);		// motorCallbacks are of this form
void motorCallback_printCurrSteps(stepperMotor*);
void stopMotorIfJobComplete(stepperMotor*);
void driveStepperPWM(which_motor_t, uint32_t, uint32_t, bool);
// End Prototypes
